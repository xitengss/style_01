<template>
  <div class="base-box base-course-detail-box">
    <div class="header">
      ...
      <el-button v-permission="'courseUpdate'" type="primary" @click="handleEdit">编辑</el-button>
    </div>
...
<script>
import { courseDetailUrl } from 'api/base'
...
export default {
  ...
  methods: {
    ...
    handleEdit (index, row) { // 修改
      this.$router.push({ name: 'baseCourseCreate', query: { id: this.detail.studyCourseId } })
    }
  }
}
</script>
